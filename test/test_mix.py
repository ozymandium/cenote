...
class TestMix(unittest.TestCase):
    ...
    def test_po2_at_depth(self):
        helpers.assert_quantity_almost_equal(O2.po2_at_depth(10.094055 * UREG.meter, Water.SALT), 2.0 * UREG.atm, 1e-6)
        helpers.assert_quantity_almost_equal(AIR.po2_at_depth(33.9989237 * UREG.foot, Water.FRESH), 0.418920 * UREG.atm, 1e-6)
