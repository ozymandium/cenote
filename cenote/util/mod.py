...
def parse_args():
    ...
    parser.add_argument("max_po2", type=float, help="Max partial pressure of oxygen in ATA.")
    parser.add_argument(
        "water", type=lambda w: Water[w], choices=list(Water), help="Type of water."
    )
