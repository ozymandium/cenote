...
template <typename Unit1, typename Unit2> void EXPECT_UNIT_NEAR(Unit1 unit1, Unit2 unit2, Unit1 unitTol)
{
    const double val1 = units::unit_cast<double>(unit1);
...
// TODO: enable_if conversion so you don't have to overload for different type
template <typename Unit1, typename Unit2> void EXPECT_UNIT_NEAR(Unit1 unit1, Unit2 unit2, Unit2 unitTol)
{
