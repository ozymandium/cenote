...
const WaterDensityLookup WATER_DENSITY{
    ...
    /// being more dense at lower temperatures.
    /// pure water at 0C is 1000 kg/m3.
    /// pick a value of pure water at 25C, since
    /// contaminnts generally decrease the
    /// density, and
    /// this
    /// will offset changes due to colder water.
    /// https://en.wikipedia.org/wiki/Properties_of_water
    {Water::FRESH, units::density::kilograms_per_cubic_meter_t(997.0474)},
    /// Deep salt water has higher density (1050
    /// kg/m3) than surface water, which varies
    /// from
    /// 1020-1029 kg/m3. Pick a median value of
    /// surface seawater at 25C.
...
units::pressure::bar_t WaterPressureFromDepth(units::length::meter_t depth, Water water) {
    ...
    // pressure from water in Pascal. 1 Pa = 1
    // kg/(m*s^2)
